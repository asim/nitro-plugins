...
func TestMangosTransportPortRange(t *testing.T) {
	tp := NewTransport()
...
func TestMangosTransportCommunication(t *testing.T) {
	tr := NewTransport()
...
func TestMangosTransportError(t *testing.T) {
	tr := NewTransport()
	...
	fn := func(sock transport.Socket) {
		...
		for {
			...
			//sock.(*transportSocket).error(&Message{
